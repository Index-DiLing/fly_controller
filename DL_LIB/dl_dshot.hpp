...
namespace dl
{
    ...
    public:
        // 8约等于7.5,高电平
        // 4约等于3.75,低电平
        volatile uint16_t realTimeData[64]       = {15, 15, 15, 15, 15, 15, 15, 15, 15, 15, 15, 15, 15, 15, 15, 15, 15, 15, 15, 15, 15, 15, 15, 15, 15, 15, 15, 15, 15, 15, 15, 15, 15, 15, 15, 15, 15, 15, 15, 15, 15, 15, 15, 15, 15, 15, 15, 15, 15, 15, 15, 15, 15, 15, 15, 15, 15, 15, 15, 15, 15, 15, 15, 15}; // 当没有数据需要传输时,会维持当前值,自动扩容至传输1K次,48=16*4,单帧
        volatile uint16_t realTimeSecondData[64] = {15, 15, 15, 15, 15, 15, 15, 15, 15, 15, 15, 15, 15, 15, 15, 15, 15, 15, 15, 15, 15, 15, 15, 15, 15, 15, 15, 15, 15, 15, 15, 15, 15, 15, 15, 15, 15, 15, 15, 15, 15, 15, 15, 15, 15, 15, 15, 15, 15, 15, 15, 15, 15, 15, 15, 15, 15, 15, 15, 15, 15, 15, 15, 15}; // 当没有数据需要传输时,会维持当前值,自动扩容至传输1K次,48=16*4,单帧

        volatile uint16_t preLoadData[64] = {0}; // 预装载数据
        volatile uint8_t exchangeData     = 0;
        dl::Timer tim;
    ...
    public:
        ...
        DShot(DSHOT_TIM timer, DSHOT_RATE rate, uint8_t sDelay = 100, uint8_t rDelay = 240) : // TODO:你说得对这里得加一坨,兼容不同rate,不过看起来像是摆设
                                                                                              ...
                                                                                              runningDelay(rDelay)
        {
            ...
            pwmDMA.setDoubleBuffer((uint8_t *)realTimeSecondData); // 这两个本应一直相等
